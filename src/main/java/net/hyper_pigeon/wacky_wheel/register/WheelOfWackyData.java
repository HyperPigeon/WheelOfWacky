...
import net.hyper_pigeon.wacky_wheel.token.TokenTypeReloadListener;
...
public class WheelOfWackyData {
    public static void init() {
        ...
        ResourceManagerHelper.get(ResourceType.SERVER_DATA).registerReloadListener(new TokenTypeReloadListener());
    }
}
